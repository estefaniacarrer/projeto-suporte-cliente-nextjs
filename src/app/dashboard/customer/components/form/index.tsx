...
//obs: primeiro forma utilizando "use client"
...
export function NewCustomerForm({ userId }: { userId: string }){
    ...
    async function handleRegisterCustomer(data: FormData) {
        ...
        router.replace("/dashboard/customer"); //redirecionamento para a lista de clientes
        router.refresh();
      }
...
//^ inicia
//finaliza
//(?:\(\d{2}\)\s?) -> validando que espera 2 digitos | \s pode ter um espaço ou não como opcional
//?\d{9} espera 9 digitos no telefone